            ...
            if (dtTable.Rows.Count > 0)
            {
                ...
                DTLoadIntoExcel.WorkBook(excelPkg,
                                        ...
                                        workSheet =>
                                        {
                                            ...
                                            workSheet.Cells["G1:J1"].Style.WrapText = true;
                                            workSheet.Cells["G1:J1"].Merge = true;
                                            workSheet.Cells["G1:J1"].Value = "Read-Repair";
                                            ...
                                            workSheet.Cells["L1:O1"].Style.WrapText = true;
                                            workSheet.Cells["L1:O1"].Merge = true;
                                            workSheet.Cells["L1:O1"].Value = "Column Counts";
                                            workSheet.Cells["L1:L2"].Style.Border.Left.Style = OfficeOpenXml.Style.ExcelBorderStyle.Medium;
                                            workSheet.Cells["O1:O2"].Style.Border.Right.Style = OfficeOpenXml.Style.ExcelBorderStyle.Medium;
